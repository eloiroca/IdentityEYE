...
<div id="novetats" class="panel panel-primary">
  <div class="panel-body">
      <h1 id="titol_novetats"><img src="{{ URL::asset('img/contingut/icono_perfil.png') }}" alt="rss_dreta"/> Editar Perfil {{ ucfirst($dades['dadesUsuari']->name) }} <img src="{{ URL::asset('img/contingut/icono_perfil.png') }}" alt="rss_esquerra"/> </h1>
  </div>
</div>
    ...
    <div id="novetat_darrera" class="col-md-12">
        <div id="cos_primerPerfil" class="panel panel-primary">
            <div class="panel-body">
                ...
                <hr class="hr_dreta">
                <form action="{{ url('dades_editarPerfil') }}" method="POST" enctype="multipart/form-data" name="form" accept-charset="utf-8">
                    <div class="col-md-6">
                            ...
                            <div class="panel-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-2-edit">
                                        <input class="form-control input" value="<?php echo $dades['dadesConfiguracio']->nom; ?>" type="text" id="nom" name="nom" required>
                                    </div>
                                    <label for="example-date-input" class="col-form-label">Apellidos</label>
                                    <div class="col-2-edit">
                                        <input class="form-control input" value="<?php echo $dades['dadesConfiguracio']->cognoms; ?>" type="text" id="cognoms" name="cognoms" required>
                                    </div>
                                    <label for="example-date-input" class="col-form-label">DNI</label>
                                    <div class="col-2-edit">
                                        <input class="form-control input" value="<?php echo $dades['dadesConfiguracio']->nif; ?>" type="text" id="dni" name="dni" required>
                                    </div>
                                    <label for="example-date-input" class="col-form-label">Fecha Nacimiento</label>
                                    <div class="col-2-edit">
                                        <input class="form-control input" value="<?php echo $dades['dadesConfiguracio']->data_naix; ?>" type="date" value="1997-07-13" name="fecha" id="fecha" required>
                                    </div>
                                    ...
                                    <div class="col-2-edit">
                                        <input class="form-control input" value="<?php echo $dades['dadesConfiguracio']->poblacio; ?>" type="text" id="poblacion" name="poblacion" required>
                                    </div>
                                    <label for="example-date-input" class="col-form-label">Oficio</label>
                                    <div class="col-2-edit">
                                        <input class="form-control input" type="text" value="<?php echo $dades['dadesConfiguracio']->ofici; ?>" id="ofici" name="ofici" required>
                                    </div>
                                    <label for="example-date-input" class="col-form-label">Contraseña</label>
                                    <div class="col-2-edit">
                                        <input class="form-control input" type="password" id="password" name="contrasenya">
                                    </div>
                                    <label for="example-date-input" class="col-form-label">Foto de Perfil</label>
                                    <div class="col-2-edit">
                                        <div class="upload-btn-wrapper">
                                            <button class="btno">Subir Archivo</button>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                   <div class="col-2-edit">
                                        ...
                                        <select id="select_pell" value="Cálida" class="form-control" name="tonal_pell" onchange="if (this.selectedIndex) tonalitat_pell();">
                                            <option>-------</option>
