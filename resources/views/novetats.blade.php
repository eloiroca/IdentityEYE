...
<div id="novetats" class="panel panel-primary">
  <div class="panel-body">
      <h1 id="titol_novetats"><img src="{{ URL::asset('img/rss.png') }}" alt="rss_dreta"/> Novedades de la Moda <img src="{{ URL::asset('img/rss.png') }}" alt="rss_esquerra"/> </h1>
  </div>
</div>
    ...
    <div id="novetat_darrera" class="col-md-9">
        <div id="novetats_esquerra" class="panel panel-primary">
            <div class="panel-body">
                <?php  
                    try{
                    //Consumir RSS de http://feeds.weblogssl.com/trendencias
