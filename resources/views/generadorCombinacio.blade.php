        ...
        <ul class="list-unstyled components">
            ...
            <li class="active">
                ...
                <ul class="collapse list-unstyled" id="pageSubmenu">
                    ...
                    <li><a href="{{ route('generarCombinacio') }}">Combinacion Aleatoria</a></li>
                </ul>
            </li>
            <li>
    ...
    <div class="panel-body">
        <div>
            ...
            <hr class="hr_dreta">
                ...
                ?>
            <br><br></div><br><div>
            <h3 class="h3_normal">Combinación Generada por IdentityEYE</h3>
            <hr class="hr_dreta">    
            <form action="{{ url('dades_afegirCombinacio') }}" method="POST" name="form" accept-charset="utf-8">
                <?php 
                 
                    for ($i=0; $i<count($dades['roba']); $i++){
                        echo "<div class='col-sm-4 cos-roba combinacio'><p class='titol-productes'>".$dades['roba'][$i]->nom."</p><input type='hidden' value='".$dades['roba'][$i]->id."' name='id_roba".$i."'><hr class='hr-productes'><img class='imatge-productes' src='".URL::asset('img/fotos_productes/'.$dades['roba'][$i]->foto)."'/><hr class='hr-productes'>".$dades['roba'][$i]->preu."€ <button type='button' class='btn btn-primary comprar-bto' onclick='comprar()' data-id='".$dades['roba'][$i]->id."'><span class='glyphicon glyphicon-shopping-cart'></span></button></div>";
                    }

                ?>
                {!! csrf_field() !!}
                <button type="button" class='btn btn-success btn_comprarCombinacio'>Comprar Combinación <span class='glyphicon glyphicon-shopping-cart'></span></button><br><br>
                <button type="submit" class="btn btn-warning btn_guardarCombinacio">Guardar Combinación <span class='glyphicon glyphicon-floppy-saved'></span></button>
            </form>
            </div>
        </div>
